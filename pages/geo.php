  ...
  <body style="position:relative;min-height:100%;">
            ...
            <?php
                $number=0;
                 ...
                 while ($data=mysqli_fetch_array($sql)){
                     ...
                     echo "<div class='row'>";
                     if($categori=='Geometri')
                     {
                         echo "
                                <div class='col-sm-11 mt-5 border border-2 border-success rounded ms-5' >
                                <p class='fs-3 text-center'>$header</p>
                                <p class='fw-light'>$yazarismi tarafından $tarih tarihinde yazıldı. </p><hr>
    ...
    <div class="row shadow-1-strong">
      <ul class="nav justify-content-center  shadow-1-strong mx-auto border-bottom pb-2 mb-2">
        ...
        <p class="text-center text-muted">© 2022 Mahire Zühal Özdemir</p></li>
    </div>
  </div>
